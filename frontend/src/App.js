  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/enfermeiro/editar" Component={EditarEnfermeiro} />
        ...
        <Route path="/episodio/editar" Component={EditarEpisodio} />
        ...
        <Route path="/ferida/editar" Component={EditarFerida} />
        ...
        <Route path="/medico/editar" Component={EditarMedico} />
        ...
        <Route path="/utente/editar" Component={EditarUtente} />
